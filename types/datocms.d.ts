...
type ImageAndTextRowBlockModelTextField = {
  __typename?: 'ImageAndTextRowBlockModelTextField';
...
/** Block of type Image and text row (image_and_text_row_block) */
type ImageAndTextRowBlockRecord = RecordInterface & {
  __typename?: 'ImageAndTextRowBlockRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  id: Scalars['ItemId']['output'];
  image?: Maybe<FileField>;
  imageRight: Scalars['BooleanType']['output'];
  text?: Maybe<ImageAndTextRowBlockModelTextField>;
};


/** Block of type Image and text row (image_and_text_row_block) */
type ImageAndTextRowBlockRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Block of type Media row (media_row_block) */
type MediaRowBlockRecord = RecordInterface & {
  __typename?: 'MediaRowBlockRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  _updatedAt: Scalars['DateTime']['output'];
  id: Scalars['ItemId']['output'];
  mediaAsset: Array<FileField>;
};


/** Block of type Media row (media_row_block) */
type MediaRowBlockRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Record of type Overview (overview) */
type OverviewRecord = RecordInterface & {
  __typename?: 'OverviewRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  _updatedAt: Scalars['DateTime']['output'];
  id: Scalars['ItemId']['output'];
  leftColumn: Array<SelectedProjectBlockRecord>;
  rightColumn: Array<SelectedProjectBlockRecord>;
};


/** Record of type Overview (overview) */
type OverviewRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type ProjectModelDescriptionField = {
...
type ProjectModelFilter = {
  ...
  _unpublishingScheduledAt?: InputMaybe<PublishedAtFilter>;
  _updatedAt?: InputMaybe<UpdatedAtFilter>;
  commisioner?: InputMaybe<StringFilter>;
...
type ProjectModelGalleryField = ImageAndTextRowBlockRecord | MediaRowBlockRecord | TextRowBlockRecord;
...
enum ProjectModelOrderBy {
  ...
  _updatedAt_ASC = '_updatedAt_ASC',
  _updatedAt_DESC = '_updatedAt_DESC',
  commisioner_ASC = 'commisioner_ASC',
  commisioner_DESC = 'commisioner_DESC',
  ...
  projectStatus_ASC = 'projectStatus_ASC',
  projectStatus_DESC = 'projectStatus_DESC',
  size_ASC = 'size_ASC',
  size_DESC = 'size_DESC',
...
type ProjectRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']['output']>;
  _updatedAt: Scalars['DateTime']['output'];
  commisioner?: Maybe<Scalars['String']['output']>;
...
/** Block of type Selected project (selected_project_block) */
type SelectedProjectBlockRecord = RecordInterface & {
  __typename?: 'SelectedProjectBlockRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Block of type Selected project (selected_project_block) */
type SelectedProjectBlockRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Block of type Staff (staff_block) */
type StaffBlockRecord = RecordInterface & {
  __typename?: 'StaffBlockRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
...
/** Block of type Staff (staff_block) */
type StaffBlockRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type TextRowBlockModelLeftColumnField = {
  __typename?: 'TextRowBlockModelLeftColumnField';
  blocks: Array<Scalars['String']['output']>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
...
type TextRowBlockModelRightColumnField = {
  __typename?: 'TextRowBlockModelRightColumnField';
  blocks: Array<Scalars['String']['output']>;
  inlineBlocks: Array<Scalars['String']['output']>;
  links: Array<Scalars['String']['output']>;
  value: Scalars['JsonField']['output'];
...
/** Block of type Text row (text_row_block) */
type TextRowBlockRecord = RecordInterface & {
  __typename?: 'TextRowBlockRecord';
  _createdAt: Scalars['DateTime']['output'];
  /** Editing URL */
  _editingUrl?: Maybe<Scalars['String']['output']>;
  _firstPublishedAt: Scalars['DateTime']['output'];
  ...
  _updatedAt: Scalars['DateTime']['output'];
  id: Scalars['ItemId']['output'];
  leftColumn?: Maybe<TextRowBlockModelLeftColumnField>;
  rightColumn?: Maybe<TextRowBlockModelRightColumnField>;
};


/** Block of type Text row (text_row_block) */
type TextRowBlockRecord_seoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
type AboutQuery = { __typename?: 'Query', about?: { __typename?: 'AboutRecord', id: any, address?: string | null, content?: { __typename?: 'AboutModelContentField', links: Array<string>, value: any, blocks: Array<{ __typename: 'StaffBlockRecord', id: any, people: Array<{ __typename?: 'PersonRecord', id: any, firstName?: string | null, lastName?: string | null, title?: string | null, phone?: string | null, email?: string | null, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null } | null }> }> } | null, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null } | null } | null };
...
type MediaThumbnailFragment = { __typename?: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null };
...
type OverviewQueryVariables = Exact<{ [key: string]: never; }>;


type OverviewQuery = { __typename?: 'Query', overview?: { __typename?: 'OverviewRecord', id: any, leftColumn: Array<{ __typename: 'SelectedProjectBlockRecord', id: any, image?: { __typename?: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null } | null, project?: { __typename?: 'ProjectRecord', id: any, title?: string | null, summary?: string | null, program?: string | null, projectStatus?: string | null, year?: string | null, size?: string | null, commisioner?: string | null, credits?: string | null, slug: string, _updatedAt: any, description?: { __typename?: 'ProjectModelDescriptionField', blocks: Array<string>, links: Array<string>, value: any } | null, gallery: Array<
          | { __typename: 'ImageAndTextRowBlockRecord', id: any, imageRight: any, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null } | null, text?: { __typename?: 'ImageAndTextRowBlockModelTextField', blocks: Array<string>, value: any, links: Array<string> } | null }
          | { __typename: 'MediaRowBlockRecord', id: any, mediaAsset: Array<{ __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null }> }
          | { __typename: 'TextRowBlockRecord', id: any, leftColumn?: { __typename?: 'TextRowBlockModelLeftColumnField', blocks: Array<string>, links: Array<string>, value: any } | null, rightColumn?: { __typename?: 'TextRowBlockModelRightColumnField', blocks: Array<string>, links: Array<string>, value: any } | null }
        > } | null }>, rightColumn: Array<{ __typename: 'SelectedProjectBlockRecord', id: any, image?: { __typename?: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null } | null, project?: { __typename?: 'ProjectRecord', id: any, title?: string | null, summary?: string | null, program?: string | null, projectStatus?: string | null, year?: string | null, size?: string | null, commisioner?: string | null, credits?: string | null, slug: string, _updatedAt: any, description?: { __typename?: 'ProjectModelDescriptionField', blocks: Array<string>, links: Array<string>, value: any } | null, gallery: Array<
          | { __typename: 'ImageAndTextRowBlockRecord', id: any, imageRight: any, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null } | null, text?: { __typename?: 'ImageAndTextRowBlockModelTextField', blocks: Array<string>, value: any, links: Array<string> } | null }
          | { __typename: 'MediaRowBlockRecord', id: any, mediaAsset: Array<{ __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null }> }
          | { __typename: 'TextRowBlockRecord', id: any, leftColumn?: { __typename?: 'TextRowBlockModelLeftColumnField', blocks: Array<string>, links: Array<string>, value: any } | null, rightColumn?: { __typename?: 'TextRowBlockModelRightColumnField', blocks: Array<string>, links: Array<string>, value: any } | null }
        > } | null }> } | null };
...
type AllProjectsQuery = { __typename?: 'Query', allProjects: Array<{ __typename?: 'ProjectRecord', id: any, title?: string | null, summary?: string | null, program?: string | null, projectStatus?: string | null, year?: string | null, size?: string | null, commisioner?: string | null, credits?: string | null, slug: string, _updatedAt: any, description?: { __typename?: 'ProjectModelDescriptionField', blocks: Array<string>, links: Array<string>, value: any } | null, gallery: Array<
      | { __typename: 'ImageAndTextRowBlockRecord', id: any, imageRight: any, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null } | null, text?: { __typename?: 'ImageAndTextRowBlockModelTextField', blocks: Array<string>, value: any, links: Array<string> } | null }
      | { __typename: 'MediaRowBlockRecord', id: any, mediaAsset: Array<{ __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null }> }
      | { __typename: 'TextRowBlockRecord', id: any, leftColumn?: { __typename?: 'TextRowBlockModelLeftColumnField', blocks: Array<string>, links: Array<string>, value: any } | null, rightColumn?: { __typename?: 'TextRowBlockModelRightColumnField', blocks: Array<string>, links: Array<string>, value: any } | null }
...
type ProjectQuery = { __typename?: 'Query', project?: { __typename?: 'ProjectRecord', id: any, title?: string | null, summary?: string | null, program?: string | null, projectStatus?: string | null, year?: string | null, size?: string | null, commisioner?: string | null, credits?: string | null, slug: string, _updatedAt: any, description?: { __typename?: 'ProjectModelDescriptionField', blocks: Array<string>, links: Array<string>, value: any } | null, gallery: Array<
      | { __typename: 'ImageAndTextRowBlockRecord', id: any, imageRight: any, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null } | null, text?: { __typename?: 'ImageAndTextRowBlockModelTextField', blocks: Array<string>, value: any, links: Array<string> } | null }
      | { __typename: 'MediaRowBlockRecord', id: any, mediaAsset: Array<{ __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null }> }
      | { __typename: 'TextRowBlockRecord', id: any, leftColumn?: { __typename?: 'TextRowBlockModelLeftColumnField', blocks: Array<string>, links: Array<string>, value: any } | null, rightColumn?: { __typename?: 'TextRowBlockModelRightColumnField', blocks: Array<string>, links: Array<string>, value: any } | null }
    > } | null };

type ProjectFragment = { __typename?: 'ProjectRecord', id: any, title?: string | null, summary?: string | null, program?: string | null, projectStatus?: string | null, year?: string | null, size?: string | null, commisioner?: string | null, credits?: string | null, slug: string, _updatedAt: any, description?: { __typename?: 'ProjectModelDescriptionField', blocks: Array<string>, links: Array<string>, value: any } | null, gallery: Array<
    | { __typename: 'ImageAndTextRowBlockRecord', id: any, imageRight: any, image?: { __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null } | null, text?: { __typename?: 'ImageAndTextRowBlockModelTextField', blocks: Array<string>, value: any, links: Array<string> } | null }
    | { __typename: 'MediaRowBlockRecord', id: any, mediaAsset: Array<{ __typename: 'FileField', alt?: string | null, basename: string, format: string, height?: any | null, id: any, mimeType: string, size: any, title?: string | null, url: string, width?: any | null, responsiveImage?: { __typename?: 'ResponsiveImage', alt?: string | null, aspectRatio: any, base64?: string | null, bgColor?: string | null, height: any, sizes: string, src: string, srcSet: string, webpSrcSet: string, title?: string | null, width: any } | null, video?: { __typename?: 'UploadVideoField', thumbnailUrl: string, streamingUrl: string, framerate?: number | null, duration?: number | null, mp4high?: string | null, mp4med?: string | null, mp4low?: string | null } | null }> }
    | { __typename: 'TextRowBlockRecord', id: any, leftColumn?: { __typename?: 'TextRowBlockModelLeftColumnField', blocks: Array<string>, links: Array<string>, value: any } | null, rightColumn?: { __typename?: 'TextRowBlockModelRightColumnField', blocks: Array<string>, links: Array<string>, value: any } | null }
  > };
